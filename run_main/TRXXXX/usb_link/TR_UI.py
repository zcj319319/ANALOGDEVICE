...
# Form implementation generated from reading ui file 'TR_UI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fs_23 = QtWidgets.QLabel(self.groupBox_2)
        self.fs_23.setFocusPolicy(QtCore.Qt.NoFocus)
        self.fs_23.setAlignment(QtCore.Qt.AlignCenter)
        self.fs_23.setObjectName("fs_23")
        self.gridLayout.addWidget(self.fs_23, 5, 0, 1, 1)
        self.n_reg_cfg = QtWidgets.QComboBox(self.groupBox_2)
        self.n_reg_cfg.setObjectName("n_reg_cfg")
        self.gridLayout.addWidget(self.n_reg_cfg, 7, 1, 1, 1)
        self.l_reg_cfg = QtWidgets.QComboBox(self.groupBox_2)
        self.l_reg_cfg.setObjectName("l_reg_cfg")
        self.gridLayout.addWidget(self.l_reg_cfg, 3, 1, 1, 1)
        self.s_reg_cfg = QtWidgets.QComboBox(self.groupBox_2)
        self.s_reg_cfg.setObjectName("s_reg_cfg")
        self.gridLayout.addWidget(self.s_reg_cfg, 5, 1, 1, 1)
        self.fs_22 = QtWidgets.QLabel(self.groupBox_2)
        self.fs_22.setFocusPolicy(QtCore.Qt.NoFocus)
        self.fs_22.setAlignment(QtCore.Qt.AlignCenter)
        self.fs_22.setObjectName("fs_22")
        self.gridLayout.addWidget(self.fs_22, 4, 0, 1, 1)
        self.j204b_update_pushButton = QtWidgets.QPushButton(self.groupBox_2)
        self.j204b_update_pushButton.setObjectName("j204b_update_pushButton")
        self.gridLayout.addWidget(self.j204b_update_pushButton, 8, 0, 1, 2)
        self.m_reg_cfg = QtWidgets.QComboBox(self.groupBox_2)
        self.m_reg_cfg.setObjectName("m_reg_cfg")
        self.gridLayout.addWidget(self.m_reg_cfg, 2, 1, 1, 1)
        self.fs_19 = QtWidgets.QLabel(self.groupBox_2)
        self.fs_19.setFocusPolicy(QtCore.Qt.NoFocus)
        self.fs_19.setAlignment(QtCore.Qt.AlignCenter)
        self.fs_19.setObjectName("fs_19")
        self.gridLayout.addWidget(self.fs_19, 1, 0, 1, 1)
        self.f_reg_cfg = QtWidgets.QComboBox(self.groupBox_2)
        self.f_reg_cfg.setObjectName("f_reg_cfg")
        self.gridLayout.addWidget(self.f_reg_cfg, 4, 1, 1, 1)
        self.fs_20 = QtWidgets.QLabel(self.groupBox_2)
        self.fs_20.setFocusPolicy(QtCore.Qt.NoFocus)
        self.fs_20.setAlignment(QtCore.Qt.AlignCenter)
        self.fs_20.setObjectName("fs_20")
        self.gridLayout.addWidget(self.fs_20, 2, 0, 1, 1)
        self.fs_24 = QtWidgets.QLabel(self.groupBox_2)
        self.fs_24.setFocusPolicy(QtCore.Qt.NoFocus)
        self.fs_24.setAlignment(QtCore.Qt.AlignCenter)
        self.fs_24.setObjectName("fs_24")
        self.gridLayout.addWidget(self.fs_24, 6, 0, 1, 1)
        self.k_reg_cfg = QtWidgets.QComboBox(self.groupBox_2)
        self.k_reg_cfg.setObjectName("k_reg_cfg")
        self.gridLayout.addWidget(self.k_reg_cfg, 6, 1, 1, 1)
        self.mem_rd_button = QtWidgets.QPushButton(self.groupBox_2)
        ...
        self.fs_25 = QtWidgets.QLabel(self.groupBox_2)
        self.fs_25.setFocusPolicy(QtCore.Qt.NoFocus)
        self.fs_25.setAlignment(QtCore.Qt.AlignCenter)
        self.fs_25.setObjectName("fs_25")
        self.gridLayout.addWidget(self.fs_25, 7, 0, 1, 1)
        self.fs_21 = QtWidgets.QLabel(self.groupBox_2)
        self.fs_21.setFocusPolicy(QtCore.Qt.NoFocus)
        self.fs_21.setAlignment(QtCore.Qt.AlignCenter)
        self.fs_21.setObjectName("fs_21")
        self.gridLayout.addWidget(self.fs_21, 3, 0, 1, 1)
        self.ntotal_reg_cfg = QtWidgets.QComboBox(self.groupBox_2)
        self.ntotal_reg_cfg.setObjectName("ntotal_reg_cfg")
        self.gridLayout.addWidget(self.ntotal_reg_cfg, 1, 1, 1, 1)
        self.gridLayout_6.addWidget(self.groupBox_2, 0, 1, 2, 1)
        ...
        self.gridLayout_3.addWidget(self.fbc_div, 1, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.refclk_div, 0, 2, 1, 1)
        self.gridLayout_6.addWidget(self.groupBox_6, 0, 2, 2, 1)
        ...
        self.gridLayout_6.addWidget(self.groupBox_9, 3, 1, 1, 2)
        ...
        self.addr_textEdit = QtWidgets.QLineEdit(self.groupBox_3)
        self.addr_textEdit.setObjectName("addr_textEdit")
        self.gridLayout_2.addWidget(self.addr_textEdit, 2, 3, 1, 1)
        self.textEdit = QtWidgets.QLineEdit(self.groupBox_3)
        self.textEdit.setObjectName("textEdit")
        self.gridLayout_2.addWidget(self.textEdit, 3, 3, 1, 1)
        self.read_button = QtWidgets.QPushButton(self.groupBox_3)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.read_button.setFont(font)
        self.read_button.setObjectName("read_button")
        self.gridLayout_2.addWidget(self.read_button, 4, 1, 1, 1)
        ...
        self.write_button = QtWidgets.QPushButton(self.groupBox_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_2.addWidget(self.write_button, 4, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.groupBox_3, 3, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_7.setTitle(_translate("MainWindow", "CLK OPTION"))
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "204B CONFIG"))
        ...
        self.groupBox_6.setTitle(_translate("MainWindow", "SDS CONFIG"))
        ...
        self.ddc_config_groupbox.setTitle(_translate("MainWindow", "DDC CONFIG"))
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "read&&write"))
        self.read_button.setText(_translate("MainWindow", "READ"))
        self.label_8.setText(_translate("MainWindow", "addr"))

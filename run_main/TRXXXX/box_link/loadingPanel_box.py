...
from run_main.TRXXXX.box_link import ControlSPI
from run_main.TRXXXX import ClkOptDialog
from run_main.TRXXXX.mainDialog1 import MainDialog1
from run_main.TRXXXX.box_link.redesigner_ui.ui import Ui_MainWindow
...
from run_main.TRXXXX.box_link.redesigner_ui import logo_rc
from run_main.TRXXXX.box_link.redesigner_ui import status_rc
from run_main.TRXXXX.box_link.redesigner_ui import struc_rc
from run_main.TRXXXX.box_link.redesigner_ui import xxx_rc
from run_main.TRXXXX.box_link.redesigner_ui import head_rc


class LoadingPanel_box(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
